...
CURATED_METRIC_CATALOG: list[CatalogMetric] = [
    ...
    available("postgraduate_enrolments", "Postgraduate enrolments", "Students and load", "student_postgraduate_total_enrolments", "Student", "Department student Section 2 provider table; postgraduate research plus coursework."),
    ...
    available("postgraduate_load", "Postgraduate load (EFTSL)", "Students and load", "student_postgraduate_total_load_eftsl", "Student", "Department student Section 4 provider table; postgraduate research plus coursework."),
    available("pg_coursework_load", "PG coursework load (EFTSL)", "Students and load", "student_postgraduate_coursework_load_eftsl", "Student", "Department student Section 4 provider table."),
    available("pg_research_load", "PG research load (EFTSL)", "Students and load", "student_postgraduate_research_load_eftsl", "Student", "Department student Section 4 provider table."),
    ...
    unavailable("postgraduate_applicants", "Postgraduate applicants", "Demand", "missing", "No consistent national provider-level public source selected yet."),
    unavailable("postgraduate_offers", "Postgraduate offers", "Demand", "missing", "No consistent national provider-level public source selected yet."),
    unavailable("postgraduate_offer_rate", "Postgraduate offer rate %", "Demand", "missing", "Requires postgraduate applicants and offers."),
    available("commencing_postgraduate_enrolments", "Commencing postgraduate enrolments", "Demand", "student_postgraduate_total_commencing_enrolments", "Student", "Department student Section 1 provider table; demand proxy where postgraduate applications/offers are unavailable."),
    ...
    available("research_degree_completions", "Research-degree completions (PhD and research masters)", "Research", "student_postgraduate_research_completions", "Student", "Department Section 14 provider completions; older files map higher doctorate, doctorate by research, and master's by research."),
    available("postgraduate_coursework_completions", "Postgraduate coursework completions", "Research", "student_postgraduate_coursework_completions", "Student", "Department Section 14 provider completions; older files map doctorate by coursework, master's extended, master's by coursework, and other postgraduate."),
